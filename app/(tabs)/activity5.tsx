...
export default function Activity5Screen() {
  ...
  const handleOptionPress = (cost: number) => {
    ...
    const interval = setInterval(() => {
      ...
      if (currentStep >= steps) {
        ...
        setTimeout(() => {
          router.push(`/(tabs)/activity-success?coins=${newCoins}`);
        }, 500);
      }
    }, 50);
  };
      ...
      <ThemedView style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <ThemedText style={styles.question}>
            You have to pay rent for this month.
          </ThemedText>
          ...
          <View style={styles.optionsContainer}>
            ...
            >
              <ThemedText style={styles.optionText}>I have to pay rent</ThemedText>
