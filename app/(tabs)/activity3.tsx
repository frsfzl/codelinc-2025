  ...
  const handleOptionPress = (cost: number) => {
    ...
    const interval = setInterval(() => {
      ...
      if (currentStep >= steps) {
        ...
        setTimeout(() => {
          router.push(`/(tabs)/activity4?coins=${newCoins}`);
        }, 500);
      }
    }, 50);
  };
      ...
      <ThemedView style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.optionsContainer}>
            ...
            >
              <ThemedText style={styles.optionText}>Buy my groceries</ThemedText>
              <View style={styles.costContainer}>
                <Image source={require('@/assets/images/penny.png')} style={styles.smallPenny} />
                <ThemedText style={styles.costText}>500</ThemedText>
              </View>
            </TouchableOpacity>
          </View>
        </View>
