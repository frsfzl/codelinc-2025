...
export default function ActivityScreen() {
  ...
  const handleOptionPress = (cost: number) => {
    ...
    if (cost === 0) {
      ...
      router.push(`/(tabs)/activity2?coins=${newCoins}`);
      return;
    }
      ...
      <ThemedView style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <ThemedText style={styles.question}>
            Your friends are inviting you to a Taylor Swift concert. Do you go?
          </ThemedText>

          <View style={styles.optionsContainer}>
            <TouchableOpacity 
              style={styles.optionButton}
              onPress={() => handleOptionPress(750)}
            >
              <ThemedText style={styles.optionText}>I'll be there</ThemedText>
              <View style={styles.costContainer}>
                <Image source={require('@/assets/images/penny.png')} style={styles.smallPenny} />
                <ThemedText style={styles.costText}>750</ThemedText>
              </View>
            </TouchableOpacity>
            ...
            >
              <ThemedText style={styles.optionText}>I'll pass</ThemedText>
              <View style={styles.costContainer}>
                <Image source={require('@/assets/images/penny.png')} style={styles.smallPenny} />
